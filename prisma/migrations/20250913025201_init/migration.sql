...
-- CreateIndex
CREATE UNIQUE INDEX "post_views_postId_fingerprint_key" ON "post_views"("postId", "fingerprint");
...
-- AddForeignKey
ALTER TABLE "posts" ADD CONSTRAINT "posts_coverImageId_fkey" FOREIGN KEY ("coverImageId") REFERENCES "images"("id") ON DELETE SET NULL ON UPDATE CASCADE;
