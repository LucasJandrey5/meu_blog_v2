...
export const metadata: Metadata = {
  ...
  description:
    "Discover practical solutions, tutorials, and insights from Lucas Jandrey, a passionate full stack developer specializing in React, Next.js, Laravel, and modern web development.",
};
...
export default async function HomePage() {
  ...
  const age = new Date().getFullYear() - new Date(2003, 2, 19).getFullYear();
            ...
            <div className="space-y-6">
              ...
              <div className="max-w-4xl mx-auto space-y-4">
                <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed">
                  ...
                  , um desenvolvedor full stack brasileiro.
                </p>

                <p className="text-lg text-muted-foreground leading-relaxed">
                  Aqui eu compartilho minha jornada, tutoriais e meu roadmap de
          ...
          <section className="space-y-12">
            <div className="text-center space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Artigos e tutoriais que eu acredito que merecem atenção
                especial.
              </p>
            </div>
          ...
          {recentPosts?.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {recentPosts.map((post, index) => (
                <PostCard
                  key={post.id}
                  post={post}
                  index={index + (featuredPosts?.length || 0)}
                />
              ))}
            </div>
          ) : (
            <div className="text-center py-20 space-y-6">
              ...
              <p className="text-muted-foreground max-w-md mx-auto leading-relaxed">
                Estou trabalhando em conteúdo incrível para compartilhar com
                você. Volte em breve para tutoriais, insights e estudos de caso
            ...
            <div className="text-center space-y-6">
              ...
              <div className="max-w-4xl mx-auto space-y-4">
                <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed">
                  Sou um desenvolvedor full stack brasileiro de {age} anos com
                  uma jornada única que começou aos 14 anos com desenvolvimento
                  de jogos. Atualmente trabalho na Five Tech, onde sou
                  responsável pelo desenvolvimento de soluções escaláveis e sou
                  responsável pela arquitetura de sistemas, implementação de
                  CI/CD e manutenção de aplicações em produção.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Minha stack técnica inclui PHP, TypeScript, Laravel, NestJS,
                  React, Next.js, GIT, Docker, GITHUB CI/CD, etc, sempre
                  aplicando as melhores práticas de desenvolvimento, arquitetura
                  limpa e metodologias ágeis.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Gosto de escrever código que seja fácil de entender e manter
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Adoro quebrar a cabeça com problemas difíceis e encontrar
                  soluções
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <h3 className="text-xl font-bold">Gosto de estudar</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Então, neste blog vou compartilhar um pouco dos meus estudos.
                </p>
              </div>
            </div>
          </div>
